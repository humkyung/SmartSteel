...
void CMainFrame::InitializeRibbon()
{
	...
	ASSERT(bNameValid);
	CMFCRibbonCategory* pCategoryHome = m_wndRibbonBar.AddCategory(strTemp, IDB_TB , IDB_TB);
	...
	bNameValid = strTemp.LoadString(ID_OCC_ROT);
	ASSERT(bNameValid);
	CMFCRibbonButton* pBtnPaste = new CMFCRibbonButton(ID_OCC_ROT, strTemp, 00);
	pPanelClipboard->Add(pBtnPaste);

	bNameValid = strTemp.LoadString(ID_OCC_ZOOM);
	ASSERT(bNameValid);
	pPanelClipboard->Add(new CMFCRibbonButton(ID_OCC_ZOOM, strTemp, 1));
	bNameValid = strTemp.LoadString(ID_OCC_FIT);
	ASSERT(bNameValid);
	pPanelClipboard->Add(new CMFCRibbonButton(ID_OCC_FIT, strTemp, 2));
