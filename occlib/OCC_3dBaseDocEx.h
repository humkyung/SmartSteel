...
class AFX_EXT_CLASS OCC_3dBaseDocEx : public OCC_BaseDoc  
{
public:
	OCC_3dBaseDocEx();
	virtual ~OCC_3dBaseDocEx();

	Handle_AIS_InteractiveContext& GetAISContext(){ return m_hAISContext; };
	Handle_V3d_Viewer GetViewer()  { return m_hViewer; };
