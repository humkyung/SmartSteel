...
assign cd = 0.194, var_type = "float";
assign cw = 0.15, var_type = "float";
assign cwt = 0.006, var_type = "float";
assign cft = 0.009, var_type = "float";
assign BD1 = 0.44, var_type = "float";
assign BW1 = 0.3, var_type = "float";
assign Bwt1 = 0.011, var_type = "float";
assign Bft1 = 0.018, var_type = "float";
assign EPL1 = 0.85, var_type = "float";
assign EPW1 = 0.3, var_type = "float";
assign EPT1 = 0.032, var_type = "float";
assign EPL12 = 0.39, var_type = "float";
...
assign Px1 = cd/2, var_type = "float";
...
assign BRAX11 = PX1+EPT1, var_type = "float";
assign BRAX12 = PX1+EPT1, var_type = "float";
...
assign BRAX15 = PX1+EPT1, var_type = "float";
assign BRAX16 = PX1+EPT1, var_type = "float";
...
assign Px2 = cd/2+EPT2, var_type = "float";
...
assign BRAX21 = PX2, var_type = "float";
assign BRAX22 = PX2, var_type = "float";
...
assign BRAX25 = PX2, var_type = "float";
assign BRAX26 = PX2, var_type = "float";
...
vert3 = -Px1, -Py1, Pzb1,
vert4 = -Px1, -Py1, Pzt1,
class = 1, grade = "A36", material = "Steel", name = "EP_0.032", 
thickness = EPT1;
plc_area
vert1 = Px2, Py2, Pzt2,
vert2 = Px2, Py2, Pzb2,
...
thickness = STt1;
plc_area
vert1 = -BRA_STIFF_X1, BRA_STIFF_Y11, BRA_STIFF_Z11,
vert2 = -BRA_STIFF_X1, BRA_STIFF_Y12, BRA_STIFF_Z12,
vert3 = -BRA_STIFF_X1, BRA_STIFF_Y13, BRA_STIFF_Z13,
vert4 = -BRA_STIFF_X1, BRA_STIFF_Y14, BRA_STIFF_Z14,
class = 1, grade = "A36", material = "Steel", name = "SP_0.012", 
thickness = STt1;
plc_area
vert1 = -(BRA_STIFF_X1-STT1), BRA_STIFF_Y15, BRA_STIFF_Z11,
vert2 = -(BRA_STIFF_X1-STT1), BRA_STIFF_Y16, BRA_STIFF_Z12,
vert3 = -(BRA_STIFF_X1-STT1), BRA_STIFF_Y17, BRA_STIFF_Z13,
vert4 = -(BRA_STIFF_X1-STT1), BRA_STIFF_Y18, BRA_STIFF_Z14,
class = 1, grade = "A36", material = "Steel", name = "SP_0.012", 
thickness = STt1;
plc_area
...
thickness = STt2;
plc_area
vert1 = BRA_STIFF_X2-STT2, BRA_STIFF_Y21, BRA_STIFF_Z21,
vert2 = BRA_STIFF_X2-STT2, BRA_STIFF_Y22, BRA_STIFF_Z22,
vert3 = BRA_STIFF_X2-STT2, BRA_STIFF_Y23, BRA_STIFF_Z23,
vert4 = BRA_STIFF_X2-STT2, BRA_STIFF_Y24, BRA_STIFF_Z24,
class = 1, grade = "A36", material = "Steel", name = "SP_0.009", 
thickness = STt2;
plc_area
vert1 = BRA_STIFF_X2, BRA_STIFF_Y25, BRA_STIFF_Z21,
vert2 = BRA_STIFF_X2, BRA_STIFF_Y26, BRA_STIFF_Z22,
vert3 = BRA_STIFF_X2, BRA_STIFF_Y27, BRA_STIFF_Z23,
vert4 = BRA_STIFF_X2, BRA_STIFF_Y28, BRA_STIFF_Z24,
class = 1, grade = "A36", material = "Steel", name = "SP_0.009", 
thickness = STt2;
plc_area
...
thickness = STt2;
plc_area
vert1 = -0.129, -0.060,-0.066,
vert2 = -0.129, -0.060,-0.084,
vert3 = -0.129, -0.075,-0.092,
vert4 = -0.129, -0.090,-0.084,
vert5 = -0.129, -0.090,-0.066,
vert6 = -0.129, -0.075,-0.058,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, 0.090,-0.066,
vert2 = -0.129, 0.090,-0.084,
vert3 = -0.129, 0.075,-0.092,
vert4 = -0.129, 0.060,-0.084,
vert5 = -0.129, 0.060,-0.066,
vert6 = -0.129, 0.075,-0.058,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, -0.060,-0.141,
vert2 = -0.129, -0.060,-0.159,
vert3 = -0.129, -0.075,-0.167,
vert4 = -0.129, -0.090,-0.159,
vert5 = -0.129, -0.090,-0.141,
vert6 = -0.129, -0.075,-0.133,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, 0.090,-0.141,
vert2 = -0.129, 0.090,-0.159,
vert3 = -0.129, 0.075,-0.167,
vert4 = -0.129, 0.060,-0.159,
vert5 = -0.129, 0.060,-0.141,
vert6 = -0.129, 0.075,-0.133,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, -0.060,-0.216,
vert2 = -0.129, -0.060,-0.234,
vert3 = -0.129, -0.075,-0.242,
vert4 = -0.129, -0.090,-0.234,
vert5 = -0.129, -0.090,-0.216,
vert6 = -0.129, -0.075,-0.208,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, 0.090,-0.216,
vert2 = -0.129, 0.090,-0.234,
vert3 = -0.129, 0.075,-0.242,
vert4 = -0.129, 0.060,-0.234,
vert5 = -0.129, 0.060,-0.216,
vert6 = -0.129, 0.075,-0.208,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, -0.060,-0.291,
vert2 = -0.129, -0.060,-0.309,
vert3 = -0.129, -0.075,-0.317,
vert4 = -0.129, -0.090,-0.309,
vert5 = -0.129, -0.090,-0.291,
vert6 = -0.129, -0.075,-0.283,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, 0.090,-0.291,
vert2 = -0.129, 0.090,-0.309,
vert3 = -0.129, 0.075,-0.317,
vert4 = -0.129, 0.060,-0.309,
vert5 = -0.129, 0.060,-0.291,
vert6 = -0.129, 0.075,-0.283,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, -0.060,-0.661,
vert2 = -0.129, -0.060,-0.679,
vert3 = -0.129, -0.075,-0.687,
vert4 = -0.129, -0.090,-0.679,
vert5 = -0.129, -0.090,-0.661,
vert6 = -0.129, -0.075,-0.653,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, 0.090,-0.661,
vert2 = -0.129, 0.090,-0.679,
vert3 = -0.129, 0.075,-0.687,
vert4 = -0.129, 0.060,-0.679,
vert5 = -0.129, 0.060,-0.661,
vert6 = -0.129, 0.075,-0.653,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, -0.060,-0.736,
vert2 = -0.129, -0.060,-0.754,
vert3 = -0.129, -0.075,-0.762,
vert4 = -0.129, -0.090,-0.754,
vert5 = -0.129, -0.090,-0.736,
vert6 = -0.129, -0.075,-0.728,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = -0.129, 0.090,-0.736,
vert2 = -0.129, 0.090,-0.754,
vert3 = -0.129, 0.075,-0.762,
vert4 = -0.129, 0.060,-0.754,
vert5 = -0.129, 0.060,-0.736,
vert6 = -0.129, 0.075,-0.728,
class = 1, grade = "A36", material = "Steel", name = "HTB_M20", 
thickness = 0.016;
plc_area
vert1 = 0.129, -0.033,-0.068,
vert2 = 0.129, -0.033,-0.082,
vert3 = 0.129, -0.045,-0.089,
vert4 = 0.129, -0.057,-0.082,
vert5 = 0.129, -0.057,-0.068,
vert6 = 0.129, -0.045,-0.061,
class = 1, grade = "A36", material = "Steel", name = "HTB_M16", 
thickness = 0.013;
plc_area
vert1 = 0.129, 0.057,-0.068,
vert2 = 0.129, 0.057,-0.082,
vert3 = 0.129, 0.045,-0.089,
vert4 = 0.129, 0.033,-0.082,
vert5 = 0.129, 0.033,-0.068,
vert6 = 0.129, 0.045,-0.061,
class = 1, grade = "A36", material = "Steel", name = "HTB_M16", 
thickness = 0.013;
plc_area
vert1 = 0.129, -0.033,-0.128,
vert2 = 0.129, -0.033,-0.142,
vert3 = 0.129, -0.045,-0.149,
vert4 = 0.129, -0.057,-0.142,
vert5 = 0.129, -0.057,-0.128,
vert6 = 0.129, -0.045,-0.121,
class = 1, grade = "A36", material = "Steel", name = "HTB_M16", 
thickness = 0.013;
plc_area
vert1 = 0.129, 0.057,-0.128,
vert2 = 0.129, 0.057,-0.142,
vert3 = 0.129, 0.045,-0.149,
vert4 = 0.129, 0.033,-0.142,
vert5 = 0.129, 0.033,-0.128,
vert6 = 0.129, 0.045,-0.121,
class = 1, grade = "A36", material = "Steel", name = "HTB_M16", 
thickness = 0.013;
plc_area
vert1 = 0.129, -0.033,-0.298,
vert2 = 0.129, -0.033,-0.312,
vert3 = 0.129, -0.045,-0.319,
vert4 = 0.129, -0.057,-0.312,
vert5 = 0.129, -0.057,-0.298,
vert6 = 0.129, -0.045,-0.291,
class = 1, grade = "A36", material = "Steel", name = "HTB_M16", 
thickness = 0.013;
plc_area
vert1 = 0.129, 0.057,-0.298,
vert2 = 0.129, 0.057,-0.312,
vert3 = 0.129, 0.045,-0.319,
vert4 = 0.129, 0.033,-0.312,
vert5 = 0.129, 0.033,-0.298,
vert6 = 0.129, 0.045,-0.291,
class = 1, grade = "A36", material = "Steel", name = "HTB_M16", 
thickness = 0.013;
