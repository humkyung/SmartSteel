...
assign cw = 0.175, var_type = "float";
assign cwt = 0.0075, var_type = "float";
assign cft = 0.011, var_type = "float";
assign BD = 0.194, var_type = "float";
assign BW = 0.15, var_type = "float";
assign Bwt = 0.006, var_type = "float";
assign Bft = 0.009, var_type = "float";
assign EPL = 0.4, var_type = "float";
assign EPW = 0.15, var_type = "float";
assign EPT = 0.019, var_type = "float";
assign EPL2 = 0.186, var_type = "float";
