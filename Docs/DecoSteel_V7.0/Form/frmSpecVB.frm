...
Begin VB.Form frmSpecVB 
   BorderStyle     =   1  '단일 고정
   Caption         =   "Connection Spec. of Vertical Bracing"
   ClientHeight    =   6135
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11220
      ...
      Begin MSComctlLib.ImageList ImageList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSpecVB.frx":85CE
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmSpecVB.frx":10BAC
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread ssData 
         ...
         SpreadDesigner  =   "frmSpecVB.frx":1918A
      End
   End
...
Else
               ...
               xSQL = "delete from VB_Connection "
               ...
               xSQL = "select shape,member_name, type, htb_name, htb_num, htb_snum, htb_space, space1, space2, plate_thk, gage, unit , code from VB_Connection where job = '" & gstr_Job & "'"
...
Else
               ...
               xSQL = "select Member_Name from VB_Connection where Member_Name = '" & CStr(Trim(txtMname.Text)) & "' "
               xSQL = xSQL & "and job = '" & gstr_Job & "'"
               If DataCheck(CStr(Trim(txtMname.Text)), xSQL) Then
                   xSQL = "update VB_Connection set "
               ...
               Else
                   xSQL = "insert into VB_Connection values ('"
                   xSQL = xSQL & gstr_Job & "', '"
               ...
               xSQL = "select shape,member_name,type,HTB_Name,HTB_Num,HTB_SNum,HTB_Space,Space1,Space2,Plate_Thk,Gage,Unit , code from VB_Connection "
...
If Len(Command) <> 0 Then
      ...
      Me.Caption = "Current Project : " & gstr_Job & " , Spec. of Vertical Bracing"
End If
